...
imgBody.setAttribute('src', './images/body0.png');

let imgShoes = document.querySelector("#imgShoes");
imgShoes.setAttribute('src', './images/shoes0.png');
...
function moveLeftRight(slide){
  ...
  // Head >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   if(fullBodyIndex === 0){
    ...
    imgHead.src = "./images/head" + currentHeadIndex + ".png"
   }  
   ...
   if(fullBodyIndex === 1){
    ...
    imgBody.src = "./images/body" + currentBodyIndex + ".png"
   }  
  ...
  // Shoes >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
   if(fullBodyIndex === 2){
    ...
    imgShoes.src = "./images/shoes" + currentShoesIndex + ".png"
   }  
